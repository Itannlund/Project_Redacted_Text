...
describe("Normalize_text", () => {
    ...
    test('Does not take away punktuation"."', ()=> {
        expect(normalize_text("hej. jag heter.")).toEqual("hej. jag heter.");
    ...
    test("takes away accents from letters", () => {
        ...
        expect(normalize_text("ïe")).toBe("ie");
        expect(normalize_text("éé")).toBe("ee");
